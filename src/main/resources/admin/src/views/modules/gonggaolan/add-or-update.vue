	...
	<div class="addEdit-block" :style='{"padding":"30px 0 0 0"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' v-if="type!='info'"  label="公告内容" prop="gonggaoneirong">
					<editor 
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' v-else-if="ruleForm.gonggaoneirong" label="公告内容" prop="gonggaoneirong">
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.gonggaoneirong = this.ruleForm.gonggaoneirong.replace(reg,'../../../springboot3no5q/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
