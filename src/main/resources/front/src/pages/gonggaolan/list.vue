	...
	<div class="list" :style='{"padding":"0","margin":"20px 7% 10px 7%","background":"none","flex":"1","width":"86%","minWidth":"850px","order":"3"}'>
		...
		<div class="list1 index-pv1" :style='{"width":"100%","padding":"0","background":"none","display":"block","height":"auto"}'>
			<div :style='{"margin":"0 0 40px 2%","flexWrap":"wrap","background":"none","display":"flex","width":"31%","position":"relative","float":"left","justifyContent":"space-between","height":"auto"}' v-for="(item, index) in dataList" :key="index" @click="toDetail(item)" class="list-item animation-box">
				<img :style='{"width":"100%","padding":"45px 30px","objectFit":"cover","background":"url(http://codegen.caihongy.cn/20230128/d927f93371f746899f81fd3ae78502d1.png) no-repeat center top / 100% 100%","display":"block","height":"275px"}' v-if="item.fengmiantupian && item.fengmiantupian.substr(0,4)=='http'" :src="item.fengmiantupian" class="image" />
				<img :style='{"width":"100%","padding":"45px 30px","objectFit":"cover","background":"url(http://codegen.caihongy.cn/20230128/d927f93371f746899f81fd3ae78502d1.png) no-repeat center top / 100% 100%","display":"block","height":"275px"}' v-else :src="baseUrl + (item.fengmiantupian?item.fengmiantupian.split(',')[0]:'')" class="image" />
				...
				<div :style='{"padding":"4px 10px","whiteSpace":"nowrap","overflow":"hidden","color":"#333","textAlign":"center","display":"inline-block","width":"100%","lineHeight":"30px","fontSize":"16px","textOverflow":"ellipsis"}' class="name ">{{item.biaoti}}</div>
				<div :style='{"padding":"4px 10px","whiteSpace":"nowrap","overflow":"hidden","color":"#333","textAlign":"center","display":"inline-block","width":"100%","lineHeight":"30px","fontSize":"16px","textOverflow":"ellipsis"}' class="name ">{{item.gonggaoleixing}}</div>
			</div>
		</div>
